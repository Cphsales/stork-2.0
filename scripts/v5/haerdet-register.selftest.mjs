...
const GATE_ENTRYPOINTS = ["recon-gate-run.mjs", "krav-gate-run.mjs", "plan-gate-run.mjs", "gate-eval.mjs", "ci-gate-dom.mjs"];   // ci-gate-dom = C4 CI-dommer (emitterer v5/gate/<id>)

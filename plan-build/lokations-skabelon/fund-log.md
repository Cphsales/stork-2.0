...
| --- | --- | --- | --- | --- | --- | --- | --- |
| A-1 | BLOKER | 3·4·5 | T10-halen genåbner netop de direkte writes kravet forbyder | K-8/ac1 · K-4/ac3 · K-2/ac6 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 A-1 (39936c64) — dømmes i B4 |
...
| A-4 | BLOKER | 3·4·6 | Planen vælger lokations-PII men leverer ingen lokationsanonymisering | K-7/ac3-4 · K-9/ac1-2 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 A-4 (39936c64) — dømmes i B4 |
| A-5 | RET | 1·2·3·6 | Den lovede fulde mapping-lifecycle kan ikke køres på den seedede mapping | K-7/ac4 · Bid 5 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 A-5 (39936c64) — dømmes i B4 |
...
| A-8 | RET | 2·5 | Flere erklærede kills kan ikke dræbes gennem den angivne effektsti | K-5 · K-8 · kill-listens metode pr. K | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 A-8 (39936c64) — dømmes i B4 |
| A-9 | BLOKER | 3·4·5·6 | Dagens pending med 24 timers undo bliver en historikændring i morgen | K-6/ac6,7,10 · M-13 · P-8's historie-invariant | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 A-9 (39936c64) — dømmes i B4 |
...
| A-11 | RET | 3·4 | Centrale RPC'er og deres interne adgangskanter er stadig build-valg | K-6/ac1,5,10 · K-8/ac1,4 · K-9 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 A-11 (39936c64) — dømmes i B4 |
...
| A-13 | BLOKER | 1·3·6 | P-8 er ikke indbundet; kædens nødvendige adaptere har intet leverancested | K-1..K-9 · M-35/P-8 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 A-13 (39936c64) — dømmes i B4 |
| A-14 | RET | 3·6 | API-sidegrænsen er omtalt, men fuldstændig læsning er ikke specificeret | K-9/ac1-2 · P-8/C10 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 A-14 (39936c64) — dømmes i B4 |
...
| --- | --- | --- | --- | --- | --- | --- |
| FUND-1 | medium | K-7 ac 4: kravets »persondata« indsnævres tavst til »direct« — adresse klassificeret indirect, anonymisering holdt inaktiv uden deklaration | 115-116 · 292 · 490/S-13 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 FUND-1 (39936c64) — dømmes i B4 |
...
| --- | --- | --- | --- | --- | --- | --- |
| F01 | MODSTRID | Nye INSERT/UPDATE-grants til authenticated vs. lovet revoke-båret lukket skrivevej | 157 · 191 · 283 · 395 vs. 124 · 460 · 527 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 F01 (39936c64) — dømmes i B4 |
...
| F03 | MODSTRID | Adresse = indirect, men lokationsanonymisering inaktiv m. begrundelse »ingen direct-felter« — kravet siger »persondata« | 115-116 · 292 · 490 · 541 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 F03 (39936c64) — dømmes i B4 |
...
| F11 | MODSTRID | Tre lovede runtime-kills (fjernet CHECK · fjernet DML-grant · udeladt mapping-kolonne) ændrer ikke den autoriserede sti | 90b · 130a · 118b | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 F11 (39936c64) — dømmes i B4 |
...
| U01 | MANGLER KILDE | P-8 behandlet som fremtidig leverance trods påstand om fastlagte bindinger — T's blob, C0-C10, N1-N9 ikke bundet | 604 · 591 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 U01 (39936c64) — dømmes i B4 |
| U02 | MANGLER KILDE | »Interne« funktioner uden komplet DDL/ACL/returtype; ingen revoke fra authenticated på 4+2 nye funktioner | 408 · 433 · 438 · 591 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 U02 (39936c64) — dømmes i B4 |
| U03 | MANGLER KILDE | Fuld non-admin-læsning lovet uden tværside-/række-synlighedskontrakt (42501 / false / delvis liste?) | 420-423 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 U03 (39936c64) — dømmes i B4 |
| U04 | MANGLER KILDE | Forsinket apply (apply-dato > payload-dato) ikke disponeret — historik-invarians vs. pending-flow | 105 · 408 · 425 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 U04 (39936c64) — dømmes i B4 |
| U05 | MANGLER KILDE | »Ingen build-tids-valg« lovet, men wrappers mangler parameterlister/defaults/named errors; numeric-/integer-udfald; trigger-DDL | 591 · 399-406 · 408 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 U05 (39936c64) — dømmes i B4 |
| U06 | MANGLER KILDE | Samlet K-7-dækning krediteret uden binding felt→audit→anonymisering→replay→retention ved senere tilladte valg | 116 · 436-440 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 U06 (39936c64) — dømmes i B4 |
| U07 | MANGLER KILDE | Alle negativer erklæret dækket, men to testkontekster (trigger-P0001 vs. 42501) ubundet; JWT-sim/superadmin skifter ikke SQL-rolle | 151 · 587 · 24 · 71/101/126 vs. 124 · 137 | rettet m. bevis | 2069aa16 (plan v2) | fold-ind-rapport-r2 §1 U07 (39936c64) — dømmes i B4 |
...
| --- | --- | --- | --- | --- | --- |
| codex-angreb r1 | 15 (8 BLOKER · 7 RET) | 0 | 15 (B3 → plan v2 2069aa16; dømmes i B4) | 0 | 0 |
| fresh-eyes plan-audit r1 | 5 (1 medium · 4 mindre) | 0 | 5 (B3; dømmes i B4) | 0 | 0 |
| P-4 kildetjek | 26 (16 MODSTRID · 10 MANGLER KILDE) | 0 | 26 (B3; dømmes i B4) | 0 | 0 |
| planner K-genlæsning r2 (NF-1/NF-2) + driver (D-1) — se afsnittet nedenfor | 3 | 3 | 0 | 0 | 0 |
| **i alt** | **49** | **3** | **46** | 0 | 0 |

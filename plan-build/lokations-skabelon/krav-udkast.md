...
Status: UDKAST (runde 2) · alle Mathias-svar 2026-09-02/03 indarbejdet · kilder pr. K citerer ledger `plan-build/lokations-skabelon/mathias-ord.md` (M-1..M-30 @ fb8184c, blob 3aad84d1) · recon_oid: 7fbd3a2f43c03ce239aa81e20483326bf438463c @ commit afcf4080a6c3619462eb9e53df10f49495e19abf · anker: masterplan §4 trin 10b / §1.12
...
**Kilder:** M-21 ("kan hvis antal hvile dage er valgt i ui") · M-25.2 ("periode styres i ui") · M-27b ("nej, men man skal kunne stoppe dvaleperioden og dermed åbne lokationen i ui" — reglen absolut, perioden stoppes i UI) · M-29.5 ("styres i retigheder" — ingen godkendelses-livscyklus) · §1.12 + Appendix A (cooldown pr. lokation, ikke pr. klient) · princip 4 (default = intet).
...
**Kilder:** M-17 (gruppe-kobling, arv, fravalg) · M-12 ("klienter skal altid kunne kobles på og fra på de enkelte lokaitoner") · M-29.1 (flere klienter på en lokation samtidig, maks 1 pr. stand) · M-30.4 ("hvad menes der med aftaler? lokationer har ingen slutdato før vi deaktivere den/nedlægger den" — ingen slutdato) · M-13 (historik bevares) · M-14 (nedlæggelse kobler af) · M-19 (genåbning arver) · forretningsforståelse §14 (klient sælges kun hvor der er tilladelse) · §1.12 (håndhævelse pr. booking-dato) · princip 9.
...
**Kilder:** M-23 ("Det står i logikker at alt skal kunne styres i ui") · M-24 (struktur/værdi-skellet: navn krævet, hvilket navn i UI) · M-29.5 ("styres i retigheder") · princip 3 (forretningslogik som data) · §1.9 (offentlige indgange som UI'ens maskinrum).

-- gov-3b-3a (#18 retning A): konvertér permission_area-RPC'er INVOKER → SECURITY DEFINER.
...
CREATE OR REPLACE FUNCTION core_identity.permission_area_upsert(p_id uuid, p_name text, p_is_active boolean DEFAULT true, p_sort_order integer DEFAULT 0)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''

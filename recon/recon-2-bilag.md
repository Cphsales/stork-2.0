...
- **migration:supabase/migrations/20260515110000_p0_gdpr_responsible_employee.sql** (code): Fjern is_active_employee_state-checket i gdpr_responsible_set → en anonymiseret/termineret medarbejder kan udnævnes som GDPR-dataansvarlig og NOT NULL-garantien peger på en person der ikke findes funktionelt; alternativt: SET NOT NULL før backfill → migrationen fejler på eksisterende row (rækkefølgen ER mønstret)
- **migration:supabase/migrations/20260515110000_p0_gdpr_responsible_employee.sql** (codex): omit-gdpr-responsible-employee-governance lader lokationspakken indføre anonymized_at/anonymiseringsflow uden databaseforankret dataansvarlig; gdpr_responsible-update-policy-open lader ansvarlig skiftes uden permission, aktiv-medarbejdercheck og audit-reason.

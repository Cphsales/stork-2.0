...
## 2.C De tre proofs
**recon-coverage (recon-gaten):** hvert flade-punkt gjort rede for · 3 bøtter · kode-punkter ≠ `intet_data` · **3-blind-uafhængighed bundet** (samme bundle-OID · separat workdir · læseforbuds- + web-forbuds-attest · konflikt-bevaring hård: kasseret uenighed → fail) · omission-devil grøn.

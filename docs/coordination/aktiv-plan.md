...
- H024 (test-idempotens + artefakt-cleanup + Node 24) afsluttet via build-PR 2026-05-16. Plan + feedback arkiveret i `docs/coordination/arkiv/` (filnavne `H024-*`). Slut-rapport følger.

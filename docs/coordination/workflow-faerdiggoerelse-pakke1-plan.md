...
**Status:** v9 (trin A) — Codex' trin-C-FEEDBACK (runde 1-9, inkl. review-/recon-dybde + doc-vægt + repo-hygiejne + test-dybde-princip) adresseret; re-request **full-scope** review (ikke drip). Frosset som plan-SHA; trin C (Codex review + Claude.ai krav-troskab, dual-hash-bundet) → trin D (Mathias plan-gate, sidst krav 5).

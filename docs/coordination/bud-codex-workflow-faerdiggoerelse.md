...
Status lukker krav-dokkets idé-liste. "Brugt" betyder, at funktionen faktisk er en del af buddets workflow. "Dækket af anden bærer" betyder, at samme metode er løst, men ikke med kandidatens produktflade som primær bærer. Henvisningerne peger på afsnit/linjer i dette bud og kan verificeres med `nl -ba docs/coordination/bud-codex-workflow-faerdiggoerelse.md`.

Jeg retter derfor flere tidligere BRUGT-mærker ned til DÆKKET eller FRAVALGT: hvis kandidatens konkrete flade ikke står i struktur/kobling/automatisering, er den ikke "brugt" i dette bud.

### Claude Code-egenskaber

| Kandidat                           | Status                | Verificerbart belæg                                                                                                                                                                                                                                                                  |
| ---------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Hooks                              | DÆKKET AF ANDEN BÆRER | **Bærer:** led-validering + mekaniske selftests/stop. **Metode:** fang fejl ved lifecycle-overgange før næste led. **Belæg:** Step 5 batch-build med led-validering, l.107-120; §3 fejl-fangst ved hvert led, l.193-202.                                                             |
| `/goal`                            | FRAVALGT              | Konkret grund: en session-/transcript-evaluator kan ikke alene binde Mathias' krav-hash, plan-SHA og fire aktørgodkendelser; buddet kræver hash/SHA/gate/evidens-binding, §2 l.153-169.                                                                                              |
| `.claude/rules/`                   | DÆKKET AF ANDEN BÆRER | **Bærer:** `docs/workflow/*`, artefakt-kontrakt og schema. **Metode:** stabile regler og rolleaktivering på tværs af aktører. **Belæg:** workflow-docs, l.311-319; mappestruktur med adapters, l.280-290.                                                                            |
| Skills                             | DÆKKET AF ANDEN BÆRER | **Bærer:** `docs/workflow/roller.md`, `docs/workflow/gates.md` og adapter-docs. **Metode:** genbrugbare rolle-/gate-procedurer uden at gøre én aktørs skill-format til sandhed. **Belæg:** rolleopsætning, l.233-257; workflow-docs, l.311-319.                                      |
| Codex-plugin                       | FRAVALGT              | Konkret grund: formel Codex-gate skal være uafhængig af Code/Claude-konteksten; ellers kan før-review og slut-gate få samme aktørflade. Buddet kræver Codex som uafhængig read-only reviewer, l.245-248, og fire aktør-godkendelser, l.225-231.                                      |
| `/loop`                            | DÆKKET AF ANDEN BÆRER | **Bærer:** event/state-machine + dispatch + notifikationer. **Metode:** kontinuerlig fremdrift uden Mathias som relæ. **Belæg:** automatiseres-listen, l.173-183; Mathias holdes ude af relæ/status, l.215-223.                                                                      |
| Statusline                         | DÆKKET AF ANDEN BÆRER | **Bærer:** evidens-register + genereret `status.json`. **Metode:** synlig led-status fra pakke-sandheden, ikke terminalsmykke. **Belæg:** evidens-register som første-klasses objekt, l.27; `status.json` projektion, l.293-296; status/log/notifikationer automatiseres, l.175-178. |
| Checkpointing (`/rewind`)          | DÆKKET AF ANDEN BÆRER | **Bærer:** commit+push, PR'er, branches/worktrees og blob-binding. **Metode:** rollback/genoptagelse på frosne artefakter på tværs af aktører. **Belæg:** egne branches/worktrees og blobs, l.35-39; blob-binding, l.153-155; delt working tree fravalgt, l.340-342.                 |
| `--from-pr`                        | DÆKKET AF ANDEN BÆRER | **Bærer:** PR/blob-binding. **Metode:** genoptagelse fra frossen PR-/commit-kontekst uden checkout-afhængighed. **Belæg:** artefakter læses fra blobs/origin-refs, l.37-38; blob-binding, l.153-155; transport-PR'er, l.179.                                                         |
| `/doctor` + `/context` + `/memory` | DÆKKET AF ANDEN BÆRER | **Bærer:** preflight + evidens-register + GitHub/historik. **Metode:** diagnose, kontekst og vedvarende pakkehukommelse uden session-memory som sandhed. **Belæg:** preflight, l.39; evidens-register, l.27 og l.268; historik/slutrapporter + GitHub, l.143 og l.306-308.           |
| Sandboxing                         | DÆKKET AF ANDEN BÆRER | **Bærer:** worktree-isolation, permission-/sti-snit, CI/checks og stop-regler. **Metode:** begræns skadeflade og stop ukendt/divergent state. **Belæg:** isolerede aktør-workspaces, l.35-39; mekaniske checks og selftest, l.111-118; ukendt/divergens stopper, l.181-183.          |
| Headless                           | DÆKKET AF ANDEN BÆRER | **Bærer:** event-dispatch til workflow-roller. **Metode:** aktører kan kaldes uden Mathias som mekanisk relæ. **Belæg:** event-opdagelse/dispatch/status automatiseres, l.175-178; Mathias holdes ude af actor-relæ og transport-PR'er, l.215-223.                                   |
| Agent SDK                          | DÆKKET AF ANDEN BÆRER | **Bærer:** workflow-kerne + adapter-docs. **Metode:** orkestrering via kontrakt, ikke én SDK. **Belæg:** kernen skal virke uanset konkrete agentværktøjer, l.12; adapters i workflow-strukturen, l.286-290.                                                                          |
| Agent view                         | DÆKKET AF ANDEN BÆRER | **Bærer:** evidens-register + status-projektion + led-log. **Metode:** observerbarhed over aktørarbejde. **Belæg:** evidens-register som pakke-ledger, l.27; status/log/notifikationer, l.175-178; `status.json`, l.293-296.                                                         |
| Agent teams                        | FRAVALGT              | Konkret grund: team-/peer-chat som rygrad giver ikke i sig selv frosne blobs, SHA-binding eller fire uafhængige gates; buddet kræver parallelle aktørbidrag i worktrees/blobs og modspil, l.35-39 og l.72-91.                                                                        |
| Workflows                          | DÆKKET AF ANDEN BÆRER | **Bærer:** workflow-kernen og `docs/workflow/*`. **Metode:** gentagelig pakkeproces med step, gates, artefaktkontrakt og evidens. **Belæg:** hovedbuddet definerer workflow-kernen, l.10-27; struktur starter i §1, l.29; workflow-docs, l.311-319.                                  |
| ultrareview                        | FRAVALGT              | Konkret grund: en ekstra stor-diff-reviewer kan ikke erstatte uafhængig Codex-gate, Claude.ai kravdom, Code build-erklæring og Mathias slut OK; fire aktør-godkendelser er bindende, l.225-231.                                                                                      |
| Routines                           | DÆKKET AF ANDEN BÆRER | **Bærer:** workflow-docs + eksekverbar regelbog/scripts. **Metode:** gentagelige procedurer og audits uden cloud-rutine som rygrad. **Belæg:** `scripts/**` som maskinlæsbar regelbog, l.318; cloud-first rygrad fravalgt fordi lokal repo/GitHub/WSL-state kræves, l.348-350.       |
| Worktrees                          | BRUGT                 | **Brugt i buddet:** Step 0 kræver egen branch/worktree pr. aktør, l.35-38; fravalget af delt working tree begrundes, l.340-342.                                                                                                                                                      |
| Auto mode                          | FRAVALGT              | Konkret grund: opaque klassifikation kan ikke være governance-gate; buddet bruger deklarerede events, filklasse, hash/SHA og stop-regler, l.181-183 og l.193-202.                                                                                                                    |
| Computer use                       | FRAVALGT              | Konkret grund: desktop-kontrol er konto-/fladeafhængig og giver ikke stabilt artifact-, author- eller SHA-bevis; gates skal være artefakt-bårne og læsbare efterfølgende, l.225-231.                                                                                                 |

### Codex-opsætning

| Kandidat                 | Status                | Verificerbart belæg                                                                                                                                                                                                                                                                     |
| ------------------------ | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| model + reasoning_effort | FRAVALGT              | Konkret grund: buddet vælger ikke Codex-model eller reasoning-effort som workflow-del; kvaliteten bæres i stedet af rolleansvar, modspil, SHA-binding og gates, l.72-91 og l.225-231.                                                                                                   |
| approval_policy          | DÆKKET AF ANDEN BÆRER | **Bærer:** transport-vs-dømmekraft-reglen + gates. **Metode:** hvad må køre automatisk, og hvad kræver menneske/aktør-dom. **Belæg:** automatiseres/aldrig-automatiseres, l.171-202; Mathias-kontrolposter, l.204-223.                                                                  |
| sandbox_mode             | DÆKKET AF ANDEN BÆRER | **Bærer:** worktree-isolation, sti-/permission-snit og fail-closed checks. **Metode:** begrænset skrive- og skadeflade. **Belæg:** Step 0 isolation, l.35-39; selftest/checks, l.111-118; stop ved ukendt/divergens, l.181-183.                                                         |
| network_access           | DÆKKET AF ANDEN BÆRER | **Bærer:** preflight + GitHub/blob-transport + trusted adapter. **Metode:** netadgang kun som verificerbar transport, ikke som beslutningsgrundlag. **Belæg:** preflight, l.39; origin-ref/blob-læsning, l.37-38; transport-PR'er og review-request, l.179.                             |
| github-plugin            | DÆKKET AF ANDEN BÆRER | **Bærer:** GitHub som PR/blob/evidens-spor, uanset plugin/CLI. **Metode:** frosne artefakter, review-requests og efterprøvbar historik. **Belæg:** GitHub-frysning, l.18; blob-binding, l.153-155; slutrapport/GitHub er sporet, l.132 og l.143.                                        |
| trust_level pr. projekt  | DÆKKET AF ANDEN BÆRER | **Bærer:** Step 0 preflight + aktør-workspaces + gate-ejerskab. **Metode:** workflow-automatik kører kun i kontrolleret repo-/worktree-kontekst. **Belæg:** pakke-id/evidens/aktør-workspaces og preflight, l.35-39; gate-binding med ejer, l.157; ukendt/divergens stopper, l.182-183. |

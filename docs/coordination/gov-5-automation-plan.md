...
**Plan-version:** V7 · konvergens-counter: 7 (V6 + V7 hver eksplicit Mathias-tilladt 2026-06-11; V7-accept omfatter bogføringsfladen inkl. plan-filer + rapport-historik: "mine gates er ordene (qwerg/slut OK, author-verificeret), ikke PR-klikkene — kæden merger aldrig før ordet er registreret". Verdikter altid på frossen version)

...
| 7    | Adapter + instruks        | `scripts/kaede/adapters/claude-ai-rolle.sh` + `docs/coordination/kaede/claude-ai-rolle-instruks.md`                   | `claude -p` m. §9.1-instruks for de to vækbare leverancer; output untracked; Code committer (step 6-adapter)                                                                   | Step 2        | Mellem — rolle-renhed (docs-lag, ingen kode-vurdering) håndhæves i instruks + Codex tjekker leverancer |
